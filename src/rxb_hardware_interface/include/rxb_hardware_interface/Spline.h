...
namespace SplineSpace {
    ...
    public:
        ...
        virtual bool SinglePointInterp(const double &x, double &y, double &dy) = 0;
        //多点插值:
    ...
    public:
        ...
        bool SinglePointInterp(const double &x, double &y, double &dy)throw(SplineFailure);
        bool SinglePointInterp(const double &x, double &y, double &dy, double &ddy)throw(SplineFailure);
        bool MultiPointInterp(const double *x, const int &num, double *y)throw(SplineFailure);
        bool MultiPointInterp(const double *x, const int &num, double *y, double *dy, double *ddy)throw(SplineFailure);
